...
export class PostService {
    ...
    private baseUrl = 'http://13.126.140.186:3001/';
    ...
    post_comment(access_token: string, post_id: string, comment_msg: string){
        let params = {
            access_token: access_token, 
            post_id: post_id,
            comment_msg: comment_msg
        };
        return this.http.post(this.baseUrl+'post_comment', params).map(res => res.json());
    }
}